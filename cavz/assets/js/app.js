...
mybutton && (window.onscroll = function() {
 ...
 $(document).ready(function() {
  // When the file input changes, show the image preview
  ...
  $("#fileInput4").change(function(e) {
    ...
    $(document).ready(function() {
  // When the file input changes, show the image preview
  $("#fileInput5").change(function(e) {
    var file = e.target.files[0];
    var reader = new FileReader();

    reader.onload = function(e) {
      $("#imagePreview5").attr("src", e.target.result).show();
    };
